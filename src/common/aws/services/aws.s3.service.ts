...
export class AwsS3Service implements IAwsS3Service {
    ...
    async createMultiPart(
        ...
        let path: string = options?.path;
        const acl: "authenticated-read" | "aws-exec-read" | "bucket-owner-full-control" | "bucket-owner-read" | "private" | "public-read" | "public-read-write" = options?.acl ? options.acl : 'public-read';
